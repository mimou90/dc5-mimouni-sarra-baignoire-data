#Créez des variables pour stocker le nom d'une entreprise, le nombre de clients et le 
#revenu moyen par client. Calculez et affichez le revenu total.

nom_entreprise = "Enedis"
